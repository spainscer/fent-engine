...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("sml", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("sml", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "2";
		app.meta["company"] = "hai";
		app.meta["file"] = "sml";
		app.meta["name"] = "SML MANIA";
		app.meta["packageName"] = "com.ninjamuffin99.funkin";
		app.meta["version"] = "0.2.0";
