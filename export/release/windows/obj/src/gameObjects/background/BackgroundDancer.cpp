...
HX_DEFINE_STACK_FRAME(_hx_pos_2f80948cb40e1b40_6_new,"gameObjects.background.BackgroundDancer","new",0x5a87ab13,"gameObjects.background.BackgroundDancer.new","gameObjects/background/BackgroundDancer.hx",6,0x35812e1d)
static const int _hx_array_data_63d225a1_1[] = {
	(int)0,(int)1,(int)2,(int)3,(int)4,(int)5,(int)6,(int)7,(int)8,(int)9,(int)10,(int)11,(int)12,(int)13,(int)14,
};
static const int _hx_array_data_63d225a1_2[] = {
	(int)15,(int)16,(int)17,(int)18,(int)19,(int)20,(int)21,(int)22,(int)23,(int)24,(int)25,(int)26,(int)27,(int)28,(int)29,
};
HX_LOCAL_STACK_FRAME(_hx_pos_2f80948cb40e1b40_22_dance,"gameObjects.background.BackgroundDancer","dance",0x0769b0a6,"gameObjects.background.BackgroundDancer.dance","gameObjects/background/BackgroundDancer.hx",22,0x35812e1d)
namespace gameObjects{
namespace background{

void BackgroundDancer_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_2f80948cb40e1b40_6_new)
HXLINE(  19)		this->danceDir = false;
HXLINE(  10)		super::__construct(x,y);
...
HXDLIN(  12)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("backgrounds/highway/limoDancer",aa,ef,4f,24)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library))));
HXLINE(  13)		this->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("bg dancer sketch PINK",64,fb,2b,a2),::Array_obj< int >::fromData( _hx_array_data_63d225a1_1,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  14)		this->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("bg dancer sketch PINK",64,fb,2b,a2),::Array_obj< int >::fromData( _hx_array_data_63d225a1_2,15),HX_("",00,00,00,00),24,false,null(),null());
...
bool BackgroundDancer_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x78a693e9) {
		if (inClassId<=(int)0x37487d75) {
			if (inClassId<=(int)0x2c01639b) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x2c01639b;
			} else {
				return inClassId==(int)0x37487d75;
			}
		} else {
...
void BackgroundDancer_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_2f80948cb40e1b40_22_dance)
...
::hx::ObjectPtr< BackgroundDancer_obj > BackgroundDancer_obj::__alloc(::hx::Ctx *_hx_ctx,Float x,Float y) {
	BackgroundDancer_obj *__this = (BackgroundDancer_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(BackgroundDancer_obj), true, "gameObjects.background.BackgroundDancer"));
...
void BackgroundDancer_obj::__register()
{
	...
	__mClass->mName = HX_("gameObjects.background.BackgroundDancer",a1,25,d2,63);
