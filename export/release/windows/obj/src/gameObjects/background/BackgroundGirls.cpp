...
HX_DEFINE_STACK_FRAME(_hx_pos_cc0b4904225a3d16_7_new,"gameObjects.background.BackgroundGirls","new",0x8fafa887,"gameObjects.background.BackgroundGirls.new","gameObjects/background/BackgroundGirls.hx",7,0xb9845a69)
HX_LOCAL_STACK_FRAME(_hx_pos_cc0b4904225a3d16_25_getScared,"gameObjects.background.BackgroundGirls","getScared",0x3013f0bd,"gameObjects.background.BackgroundGirls.getScared","gameObjects/background/BackgroundGirls.hx",25,0xb9845a69)
HX_LOCAL_STACK_FRAME(_hx_pos_cc0b4904225a3d16_32_dance,"gameObjects.background.BackgroundGirls","dance",0xd4a2f31a,"gameObjects.background.BackgroundGirls.dance","gameObjects/background/BackgroundGirls.hx",32,0xb9845a69)
namespace gameObjects{
namespace background{

void BackgroundGirls_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_cc0b4904225a3d16_7_new)
...
HXDLIN(  14)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("backgrounds/school/bgFreaks",a6,43,4d,56)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library))));
HXLINE(  16)		 ::flixel::animation::FlxAnimationController _hx_tmp1 = this->animation;
HXDLIN(  16)		_hx_tmp1->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("BG girls group",1b,d2,55,9d),::meta::CoolUtil_obj::numberArray(14,null()),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  17)		 ::flixel::animation::FlxAnimationController _hx_tmp2 = this->animation;
HXDLIN(  17)		_hx_tmp2->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("BG girls group",1b,d2,55,9d),::meta::CoolUtil_obj::numberArray(30,15),HX_("",00,00,00,00),24,false,null(),null());
...
bool BackgroundGirls_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x78a693e9) {
		if (inClassId<=(int)0x2c01639b) {
			if (inClassId<=(int)0x121decf9) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x121decf9;
			} else {
...
void BackgroundGirls_obj::getScared(){
            	HX_STACKFRAME(&_hx_pos_cc0b4904225a3d16_25_getScared)
HXLINE(  26)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN(  26)		_hx_tmp->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("BG fangirls dissuaded",b1,42,22,06),::meta::CoolUtil_obj::numberArray(14,null()),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  27)		 ::flixel::animation::FlxAnimationController _hx_tmp1 = this->animation;
HXDLIN(  27)		_hx_tmp1->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("BG fangirls dissuaded",b1,42,22,06),::meta::CoolUtil_obj::numberArray(30,15),HX_("",00,00,00,00),24,false,null(),null());
...
void BackgroundGirls_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_cc0b4904225a3d16_32_dance)
...
::hx::ObjectPtr< BackgroundGirls_obj > BackgroundGirls_obj::__alloc(::hx::Ctx *_hx_ctx,Float x,Float y) {
	BackgroundGirls_obj *__this = (BackgroundGirls_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(BackgroundGirls_obj), true, "gameObjects.background.BackgroundGirls"));
...
void BackgroundGirls_obj::__register()
{
	...
	__mClass->mName = HX_("gameObjects.background.BackgroundGirls",15,59,69,47);
