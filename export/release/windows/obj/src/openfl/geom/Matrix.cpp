...
HXLINE( 799)		{
HXLINE( 799)			 ::lime::math::Matrix3 _this = ::openfl::geom::Matrix_obj::_hx___matrix3;
HXDLIN( 799)			_this->a = this->a;
HXDLIN( 799)			_this->b = this->b;
HXDLIN( 799)			_this->c = this->c;
HXDLIN( 799)			_this->d = this->d;
HXDLIN( 799)			_this->tx = this->tx;
HXDLIN( 799)			_this->ty = this->ty;
            		}
...
{
            	HX_GC_STACKFRAME(&_hx_pos_99143fe9fb0bb031_82_boot)
HXDLIN(  82)		_hx___matrix3 =  ::lime::math::Matrix3_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            	}
}
