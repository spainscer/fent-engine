...
HXLINE(1077)		if (::hx::IsEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXDLIN(1198)			if (::hx::IsEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(1448)			 ::haxe::io::Bytes bytes = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(data);
...
HXDLIN(1932)		if (::hx::IsNotEq( this->_hx___contextState->_hx___currentGLArrayBuffer,buffer )) {
...
HXDLIN(1941)		if (::hx::IsNotEq( this->_hx___contextState->_hx___currentGLElementArrayBuffer,buffer )) {
...
HXDLIN(1950)		if (::hx::IsNotEq( this->_hx___contextState->_hx___currentGLFramebuffer,framebuffer )) {
...
HXDLIN(2011)			if (::hx::IsEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXDLIN(2163)			if (::hx::IsEq( this->_hx___contextState->renderToTexture,this->_hx___state->renderToTexture )) {
...
HXLINE(2188)				_hx_tmp3 = ::hx::IsNotEq( this->_hx___contextState->_hx___currentGLFramebuffer,this->_hx___state->_hx___primaryGLFramebuffer );
            			}
            			else {
...
HXLINE(2202)			this->_hx___setGLFrontFace(::hx::IsNotEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) ));
            		}
            	}
...
HXLINE(2211)		if (::hx::IsNotEq( this->_hx___contextState->shader,shader )) {
...
HXLINE(2228)		if (::hx::IsNotEq( this->_hx___contextState->program,program )) {
...
HXDLIN(2245)				if (::hx::IsEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(2420)			if (::hx::IsEq( this->_hx___stage->context3D,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE(2549)			_hx_tmp4 = ::hx::IsNotEq( context,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
