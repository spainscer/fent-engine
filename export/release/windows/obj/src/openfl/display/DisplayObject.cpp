...
HXLINE(1224)			_hx_tmp = ::hx::IsNotEq( targetCoordinateSpace,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE(1482)			_hx_tmp = ::hx::IsNotEq( parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE(1508)			if (::hx::IsEq( this->parent,this->stage )) {
...
HXLINE(1520)					stack->set(i,parent).StaticCast<  ::openfl::display::DisplayObject >();
...
HXLINE(1639)				while(::hx::IsNotEq( current,this->stage )){
...
HXLINE(1663)		if (::hx::IsEq( global,local )) {
...
HXLINE(2094)		if (::hx::IsEq( value,this->_hx___mask )) {
HXLINE(2096)			return value;
            		}
HXLINE(2099)		if (::hx::IsNotEq( value,this->_hx___mask )) {
...
HXLINE(2120)			_hx_tmp = ::hx::IsNotEq( this->_hx___cacheBitmap->get_mask(),value );
            		}
            		else {
