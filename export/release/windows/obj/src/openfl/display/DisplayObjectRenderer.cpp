...
HXLINE( 449)							 ::openfl::geom::Matrix textField1 = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 449)							textField1->tx = (textField1->tx - (textField->_hx___offsetX * pixelRatio));
HXLINE( 450)							 ::openfl::geom::Matrix textField2 = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 450)							textField2->ty = (textField2->ty - (textField->_hx___offsetY * pixelRatio));
            						}
            					}
...
HXLINE( 470)				if (::hx::IsEq( bitmapMatrix,displayObject->_hx___renderTransform )) {
...
HXLINE( 482)					 ::openfl::geom::Matrix displayObject1 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 482)					displayObject1->a = (displayObject1->a * (( (Float)(1) ) / pixelRatio));
HXLINE( 483)					 ::openfl::geom::Matrix displayObject2 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 483)					displayObject2->d = (displayObject2->d * (( (Float)(1) ) / pixelRatio));
HXLINE( 484)					 ::openfl::geom::Matrix displayObject3 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 484)					displayObject3->tx = (displayObject3->tx + offsetX);
HXLINE( 485)					 ::openfl::geom::Matrix displayObject4 = displayObject->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 485)					displayObject4->ty = (displayObject4->ty + offsetY);
            				}
            			}
...
HXLINE( 542)				 ::openfl::geom::Matrix displayObject1 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 542)				displayObject1->tx = (displayObject1->tx - offsetX);
HXLINE( 543)				 ::openfl::geom::Matrix displayObject2 = displayObject->_hx___cacheBitmapRenderer->_hx___worldTransform;
HXDLIN( 543)				displayObject2->ty = (displayObject2->ty - offsetY);
...
HXLINE( 785)									_hx_tmp = ::hx::IsEq( lastBitmap,bitmap2 );
            								}
            								else {
...
HXLINE( 793)						if (::hx::IsNotEq( displayObject->_hx___cacheBitmapData,bitmap )) {
...
HXLINE( 853)				 ::openfl::geom::Matrix textField1 = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 853)				textField1->tx = (textField1->tx - textField->_hx___offsetX);
HXLINE( 854)				 ::openfl::geom::Matrix textField2 = textField->_hx___cacheBitmap->_hx___renderTransform;
HXDLIN( 854)				textField2->ty = (textField2->ty - textField->_hx___offsetY);
            			}
            		}
