...
HXLINE( 357)			_hx_tmp = ::hx::IsNotEq( targetCoordinateSpace,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE( 580)		if (::hx::IsNotEq( value,this->_hx___colorTransform )) {
...
HXLINE( 641)		if (::hx::IsNotEq( value,this->_hx___matrix )) {
...
HXLINE( 692)		if (::hx::IsNotEq( value,this->_hx___rect )) {
...
HXLINE( 842)		if (::hx::IsNotEq( value,this->_hx___shader )) {
...
HXLINE( 858)		if (::hx::IsNotEq( value,this->_hx___tileset )) {
