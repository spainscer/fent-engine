...
HXLINE( 212)			if (::hx::IsEq( child,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE( 219)				if (::hx::IsEq( child->stage,child )) {
...
HXLINE( 232)		if (::hx::IsEq( child->parent,::hx::ObjectPtr<OBJ_>(this) )) {
HXLINE( 234)			if (::hx::IsNotEq( this->_hx___children->__get(index).StaticCast<  ::openfl::display::DisplayObject >(),child )) {
...
HXDLIN( 339)			if (::hx::IsNotEq( child,::hx::ObjectPtr<OBJ_>(this) )) {
...
HXLINE( 341)			child = child->parent;
            		...
            		_hx_goto_4:;
HXLINE( 344)		return ::hx::IsEq( child,::hx::ObjectPtr<OBJ_>(this) );
            	}
...
HXLINE( 415)				if (::hx::IsEq( this->_hx___children->__get(i).StaticCast<  ::openfl::display::DisplayObject >(),child )) {
HXLINE( 415)					return i;
            				}
            			}
            		}
...
HXLINE( 469)			_hx_tmp = ::hx::IsEq( child->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXLINE( 480)					_hx_tmp = ::hx::IsEq( this->stage->get_focus(),child );
            				}
            				else {
...
HXDLIN( 625)			_hx_tmp = ::hx::IsEq( child->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
...
HXDLIN( 658)		if (::hx::IsEq( child1->parent,::hx::ObjectPtr<OBJ_>(this) )) {
HXDLIN( 658)			_hx_tmp = ::hx::IsEq( child2->parent,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
