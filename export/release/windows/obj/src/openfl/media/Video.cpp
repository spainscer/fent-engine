...
HXLINE( 303)			_hx_tmp = ::hx::IsNotEq( this->_hx___indexBufferContext,context->_hx___context );
            		}
            		else {
...
HXLINE( 357)			_hx_tmp2 = ::hx::IsNotEq( this->_hx___vertexBufferContext,context->_hx___context );
            		}
            		else {
