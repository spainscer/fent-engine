...
HXLINE(  83)				textFormatRanges->splice(1,(textFormatRanges->get_length() - 1));
            			}
...
HXLINE(  95)			textFormatRanges->splice(0,textFormatRanges->get_length());
