...
HXLINE( 291)		 ::openfl::net::URLLoader _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 379)			if (::hx::IsEq( ::Type_obj::_hx_typeof(request->data),::ValueType_obj::TObject_dyn() )) {
...
HXLINE( 432)		if (::Std_obj::isOfType(this->_hx___httpRequest,( ( ::Dynamic)(::hx::ClassOf< ::lime::net::_HTTPRequest_Bytes >()) ))) {
...
HXLINE( 437)			if (::Std_obj::isOfType(this->_hx___httpRequest,( ( ::Dynamic)(::hx::ClassOf< ::lime::net::_HTTPRequest_String >()) ))) {
