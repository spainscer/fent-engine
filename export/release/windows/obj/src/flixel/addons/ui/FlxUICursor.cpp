...
HXLINE( 956)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseMove",d6,9b,b5,f4),true,false,pt1,pt2,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this3->keyManager->checkStatus(16,_this3->status),null(),null(),null(),null(),null()));
            		}
...
HXLINE( 992)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseDown",27,b1,c2,ee),true,false,rawMouseX,rawMouseY,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this2->keyManager->checkStatus(16,_this2->status),null(),null(),null(),null(),null()));
            		}
...
HXLINE(1038)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,rawMouseX,rawMouseY,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this2->keyManager->checkStatus(16,_this2->status),null(),null(),null(),null(),null()));
...
HXLINE(1041)				_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("click",48,7c,5e,48),true,false,rawMouseX,rawMouseY,_hx_tmp1,_hx_tmp2,_hx_tmp3,_this2->keyManager->checkStatus(16,_this2->status),null(),null(),null(),null(),null()));
            			}
            		}
