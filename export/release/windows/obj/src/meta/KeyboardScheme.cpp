...
::meta::KeyboardScheme KeyboardScheme_obj::Custom;

::meta::KeyboardScheme KeyboardScheme_obj::Duo(bool first)
{
	return ::hx::CreateEnum< KeyboardScheme_obj >(HX_("Duo",9e,ff,33,00),1,1)->_hx_init(0,first);
}

::meta::KeyboardScheme KeyboardScheme_obj::None;

::meta::KeyboardScheme KeyboardScheme_obj::Solo;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("meta.KeyboardScheme",d5,ab,3a,6d), ::hx::TCanCast< KeyboardScheme_obj >,KeyboardScheme_obj_sStaticFields,0,
