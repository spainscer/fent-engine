...
::meta::Control Control_obj::ACCEPT;

::meta::Control Control_obj::BACK;

::meta::Control Control_obj::CHEAT;

::meta::Control Control_obj::DOWN;

::meta::Control Control_obj::LEFT;

::meta::Control Control_obj::PAUSE;

::meta::Control Control_obj::RESET;

::meta::Control Control_obj::RIGHT;

::meta::Control Control_obj::UP;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("meta.Control",94,2c,5c,13), ::hx::TCanCast< Control_obj >,Control_obj_sStaticFields,0,
