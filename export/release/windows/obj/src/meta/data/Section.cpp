...
HX_DEFINE_STACK_FRAME(_hx_pos_b4f71d9fc1a0803b_14_new,"meta.data.Section","new",0x14c038bc,"meta.data.Section.new","meta/data/Section.hx",14,0xf57ec694)
HX_LOCAL_STACK_FRAME(_hx_pos_b4f71d9fc1a0803b_25_boot,"meta.data.Section","boot",0x0b8a6c56,"meta.data.Section.boot","meta/data/Section.hx",25,0xf57ec694)
namespace meta{
namespace data{
...
bool Section_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x39cfb72e;
}
...
void Section_obj::__register()
{
	...
	__mClass->mName = HX_("meta.data.Section",ca,6a,96,2a);
...
{
{
            	HX_STACKFRAME(&_hx_pos_b4f71d9fc1a0803b_25_boot)
HXDLIN(  25)		COPYCAT = 0;
            	}
}
