...
HX_DEFINE_STACK_FRAME(_hx_pos_6a3cf5578fe1376e_26_new,"meta.data.Song","new",0x7b94b6c2,"meta.data.Song.new","meta/data/Song.hx",26,0xf5bec68e)
HX_LOCAL_STACK_FRAME(_hx_pos_6a3cf5578fe1376e_45_loadFromJson,"meta.data.Song","loadFromJson",0xfe913a56,"meta.data.Song.loadFromJson","meta/data/Song.hx",45,0xf5bec68e)
HX_LOCAL_STACK_FRAME(_hx_pos_6a3cf5578fe1376e_55_parseJSONshit,"meta.data.Song","parseJSONshit",0x700efdfd,"meta.data.Song.parseJSONshit","meta/data/Song.hx",55,0xf5bec68e)
namespace meta{
namespace data{
...
HXLINE(  39)		this->song = song;
HXLINE(  40)		this->notes = notes;
HXLINE(  41)		this->bpm = bpm;
            	}
...
bool Song_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7cd849e0;
}

 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_6a3cf5578fe1376e_45_loadFromJson)
HXLINE(  46)		::String song = folder.toLowerCase();
HXDLIN(  46)		::String secondSong = jsonInput.toLowerCase();
HXDLIN(  46)		::String library = null();
HXDLIN(  46)		::String rawJson = ((HX_("songs/",71,e7,88,2d) + song.toLowerCase()) + HX_("/",2f,00,00,00));
HXDLIN(  46)		::String rawJson1 = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((rawJson + secondSong.toLowerCase()) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  48)		while(!(::StringTools_obj::endsWith(rawJson1,HX_("}",7d,00,00,00)))){
HXLINE(  49)			rawJson1 = rawJson1.substr(0,(rawJson1.length - 1));
            		}
HXLINE(  51)		return ::meta::data::Song_obj::parseJSONshit(rawJson1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_6a3cf5578fe1376e_55_parseJSONshit)
HXLINE(  56)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE(  57)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE(  58)		return swagShit;
            	}
...
void Song_obj::__register()
{
	...
	__mClass->mName = HX_("meta.data.Song",d0,ed,85,fb);
