...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("sml",92,a2,57,00),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("hai",50,3f,4f,00));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("sml",92,a2,57,00));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("SML MANIA",a4,24,49,3d));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.ninjamuffin99.funkin",15,26,25,5b));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.2.0",b6,c1,c9,c1));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("SML MANIA",a4,24,49,3d))
