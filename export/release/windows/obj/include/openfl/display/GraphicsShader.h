...
class HXCPP_CLASS_ATTRIBUTES GraphicsShader_obj : public  ::openfl::display::Shader_obj
{
	...
	public:
		...
		void __construct(::String __o_glVertexSource,::String __o_glFragmentSource,::hx::Null< bool >  __o_initNow);
		...
		static ::hx::ObjectPtr< GraphicsShader_obj > __new(::String __o_glVertexSource,::String __o_glFragmentSource,::hx::Null< bool >  __o_initNow);
		static ::hx::ObjectPtr< GraphicsShader_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o_glVertexSource,::String __o_glFragmentSource,::hx::Null< bool >  __o_initNow);
		...
		::String glVertexHeader;
		::String glVertexBody;
		::String glFragmentHeader;
		::String glFragmentBody;
		void _hx___initGL();

		void processSource();
		::Dynamic processSource_dyn();
