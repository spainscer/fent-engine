...
#define INCLUDED_meta_data_Highscore
...
HX_DECLARE_CLASS2(meta,data,Highscore)
...
class HXCPP_CLASS_ATTRIBUTES Highscore_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x3753021d };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="meta.data.Highscore")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"meta.data.Highscore"); }
		...
		inline static ::hx::ObjectPtr< Highscore_obj > __alloc(::hx::Ctx *_hx_ctx) {
			Highscore_obj *__this = (Highscore_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Highscore_obj), false, "meta.data.Highscore"));
...
#endif /* INCLUDED_meta_data_Highscore */ 
