...
#define INCLUDED_meta_state_TitleState
...
HX_DECLARE_CLASS2(meta,state,TitleState)

namespace meta{
namespace state{


class HXCPP_CLASS_ATTRIBUTES TitleState_obj : public  ::meta::MusicBeatState_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x1fe9faa5 };

		void __construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="meta.state.TitleState")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"meta.state.TitleState"); }
...
#endif /* INCLUDED_meta_state_TitleState */ 
