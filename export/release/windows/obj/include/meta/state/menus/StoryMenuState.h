...
#define INCLUDED_meta_state_menus_StoryMenuState
...
HX_DECLARE_CLASS3(meta,state,menus,StoryMenuState)
...
class HXCPP_CLASS_ATTRIBUTES StoryMenuState_obj : public  ::meta::MusicBeatState_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x07197465 };

		void __construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="meta.state.menus.StoryMenuState")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"meta.state.menus.StoryMenuState"); }
...
#endif /* INCLUDED_meta_state_menus_StoryMenuState */ 
