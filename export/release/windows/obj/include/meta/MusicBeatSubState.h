...
#define INCLUDED_meta_MusicBeatSubState
...
class HXCPP_CLASS_ATTRIBUTES MusicBeatSubState_obj : public  ::flixel::FlxSubState_obj
{
	...
	public:
		enum { _hx_ClassId = 0x72d40f07 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="meta.MusicBeatSubState")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"meta.MusicBeatSubState"); }
...
#endif /* INCLUDED_meta_MusicBeatSubState */ 
