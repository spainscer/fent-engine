...
#define INCLUDED_gameObjects_background_BackgroundDancer
...
HX_DECLARE_CLASS2(gameObjects,background,BackgroundDancer)
...
class HXCPP_CLASS_ATTRIBUTES BackgroundDancer_obj : public  ::meta::data::dependency::FNFSprite_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x37487d75 };

		void __construct(Float x,Float y);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="gameObjects.background.BackgroundDancer")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"gameObjects.background.BackgroundDancer"); }
...
#endif /* INCLUDED_gameObjects_background_BackgroundDancer */ 
