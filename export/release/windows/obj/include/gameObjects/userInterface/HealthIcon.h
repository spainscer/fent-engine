...
#define INCLUDED_gameObjects_userInterface_HealthIcon
...
class HXCPP_CLASS_ATTRIBUTES HealthIcon_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		enum { _hx_ClassId = 0x29f35c41 };

		void __construct(::String __o__hx_char,::hx::Null< bool >  __o_isPlayer);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="gameObjects.userInterface.HealthIcon")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"gameObjects.userInterface.HealthIcon"); }
		...
		Float initialWidth;
		Float initialHeight;
		void updateIcon(::String _hx_char,::hx::Null< bool >  isPlayer);
...
#endif /* INCLUDED_gameObjects_userInterface_HealthIcon */ 
